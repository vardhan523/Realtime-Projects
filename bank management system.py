...
speak="Welcome to vardhan bank please go through the Menu"
...
customerNames=['Anand Vardhan', 'shivaji','Bharat','surya','Naveen']  #this is i first i is 0 when new customer enters here
    ...
    if choiceNumber== "1":
        ...
        if i > 5: #output shows ("Customer registration exceed reached or customer registration too low") if usres more than 5 for new accounts
            ...
            while counter_1 <= i:
                ...
                speak="Your account has been created successful"
                text_speech.say(speak)
                text_speech.runAndWait()
        ...
        speak="Thank you for visiting vardhan Bank please visit again"
        text_speech.say(speak)
        text_speech.runAndWait()
        ...
        print("\n")
        print("Thankyou for visiting vardhan Bank")
        break
